...
namespace Laba_6
{
    class Emitter
    {
        ...
        public void UpdateState()
        {
            ...
            // Удаляем мёртвые частицы из списка
            particles.RemoveAll(p => p.Life <= 0);

            // Обновляем состояние оставшихся частиц
            ...
            // Создаём новые частицы, если нужно
        ...
        /* добавил метод генерации частицы, если захотим переопределить его*/
